...
export HYBRID_LEGACY_FRACTION="${HYBRID_LEGACY_FRACTION:-0.1}"
...
export PPO_EPOCHS_AUTO="${PPO_EPOCHS_AUTO:-0}"
export PPO_EPOCHS="${PPO_EPOCHS:-10}"
export PPO_EPOCHS_MIN="${PPO_EPOCHS_MIN:-4}"
export PPO_EPOCHS_MAX="${PPO_EPOCHS_MAX:-10}"
export PPO_TARGET_KL="${PPO_TARGET_KL:-0.015}"
...
export PPO_LEARNING_RATE="${PPO_LEARNING_RATE:-6.5e-5}"
